"""
HomeFixGuide Auto Post Generator v2
...
BLOG_NAME = "HomeFixGuide"
BLOG_NICHE = "home improvement and DIY"
BLOG_DESCRIPTION = "Practical home repair guides and DIY projects for every homeowner."

CATEGORIES = [
    "diy-projects",     "plumbing",     "electrical",     "painting",
    "organization",     "tools",     "outdoor",     "kitchen-remodel",
    "bathroom-remodel",     "flooring",     "landscaping",     "pest-control",
    "energy-efficiency",     "storage-solutions",     "home-maintenance",
]

SYSTEM_PROMPT = """You are an expert home improvement and DIY writer for HomeFixGuide.
...
- Write as a licensed contractor and DIY expert sharing expertise
