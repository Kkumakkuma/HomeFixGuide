"""
HomeFixGuide - Gumroad Promotional Post Generator v2
...
PROMO_PRODUCTS = [
    {
        ...
        "desc": "Never miss a home maintenance task with our Notion scheduler.",
        "keywords": ["home maintenance", "house upkeep", "seasonal maintenance", "property care"],
    },
    {
        "name": "Renovation Budget Planner",
        "price": "$7.99",
        "slug": "renovation-budget",
        "desc": "Plan and track your renovation budget with our detailed Notion template.",
        "keywords": ["renovation budget", "remodeling cost", "home improvement budget", "project planning"],
    },
]

PROMO_SYSTEM_PROMPT = """You are an expert home improvement and DIY writer.
