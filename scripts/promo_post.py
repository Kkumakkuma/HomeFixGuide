"""
HomeFixGuide - Gumroad Promotional Post Generator
...
PROMO_PRODUCTS = [
    {"name": "Home Maintenance Scheduler", "price": "$7.99", "slug": "home-maintenance", "desc": "Never miss a home maintenance task with seasonal checklists."},
    {"name": "Renovation Budget Planner", "price": "$7.99", "slug": "reno-budget", "desc": "Plan renovations without budget surprises."},
]

PROMO_SYSTEM_PROMPT = """You are an expert home improvement writer.
